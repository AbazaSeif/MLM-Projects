...
###Write Up Fix
We expected a flatter because the random effects were removed from the residuals.
```{r}
...
We have tested the model on several machines and on some machines it is running 0.00 no matter what decimal place we set. Therefore, we have run the model on Danny's machine and grabbed his zeta1 for now.
